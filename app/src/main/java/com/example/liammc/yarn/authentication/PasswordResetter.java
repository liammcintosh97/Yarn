...
public class PasswordResetter {
    ...
    private static String TAG = "PasswordResetter";
            ...
            authenticator.login(activity, localUser.email, passwordInput.getText().toString()
                    , new AuthListener() {
                            ...
                            localUser.updator.updatePassword(newPasswordInput.getText().toString()
                                    , new AuthListener() {
                                        ...
                                        public void onError() {
                                            ...
                                            Toast.makeText(activity,"There was an error updating password"
                                                    ,Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                        ...
                        public void onError() {
                            ...
                            Toast.makeText(activity,"Current password is incorrect"
                                    ,Toast.LENGTH_SHORT).show();
                        }
                    });
